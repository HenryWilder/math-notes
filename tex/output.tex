...
\begin{document}
    \maketitle
    \chapter{Properties}\section{Reflexive}\section{Symmetric}\section{Transitive}\section{Substitution}\section{Identity}\section{Fixed Point}\section{Cancellation}\section{Associative}\section{Inverse}\section{Sum of}\section{Difference of}\section{Product of}\section{Quotient of}\section{Power of}\section{Log of}\subsection{Natural Log of}\section{Exponents of}\section{Chain}\section{Trig}\subsection{Definitions}\subsection{Pythagorean}\subsection{Angle Sum and Difference}\subsubsection{Double Angle}\subsection{Derivatives}
\end{document}
